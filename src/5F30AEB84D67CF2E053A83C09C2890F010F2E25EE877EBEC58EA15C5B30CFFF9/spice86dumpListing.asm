...
5642:0990 popf
5642:0991 ret near
5BAE:0100 jmp near 0x01CB
5BAE:0103 jmp near 0x0250
5BAE:0106 jmp near 0x01E1
5BAE:010C jmp near 0x01EE
5BAE:010F jmp near 0x030F
5BAE:0112 jmp near 0x022B
5BAE:01A8 push SS
5BAE:01A9 pop ES
5BAE:01AA mov SI,BP
5BAE:01AC lods AX,word ptr ES:[SI]
5BAE:01AE add AX,2
5BAE:01B1 mov DI,AX
5BAE:01B3 push CX
5BAE:01B4 mov CX,9
5BAE:01B7 mov AL,0x2E
5BAE:01B9 repne scas AL,byte ptr ES:[DI]
5BAE:01BB pop CX
5BAE:01BC jne short 0x01C8
5BAE:01BE mov AX,word ptr CS:[0x01A5]
5BAE:01C2 stos word ptr ES:[DI],AX
5BAE:01C3 mov AL,byte ptr CS:[0x01A7]
5BAE:01C7 stos byte ptr ES:[DI],AL
5BAE:01C8 loop 0x01AC
5BAE:01CA ret near
5BAE:01CB or AX,AX
5BAE:01CD je short 0x01D3
5BAE:01CF mov word ptr CS:[0x0125],AX
5BAE:01D3 call near 0x01A8
5BAE:01D6 call near 0x0559
5BAE:01D9 push CS
5BAE:01DA call near 0x01E1
5BAE:01DD mov BX,0x0500
5BAE:01E0 ret far
5BAE:01E1 pushf
5BAE:01E2 cli
5BAE:01E3 call near 0x052F
5BAE:01E6 xor AX,AX
5BAE:01E8 mov byte ptr CS:[0x0139],AL
5BAE:01EC popf
5BAE:01ED ret far
5BAE:01EE push BX
5BAE:01EF mov BX,0xFFFF
5BAE:01F2 cmp AX,0x0060
5BAE:01F5 jb short 0x0211
5BAE:01F7 mov BX,0xAAAA
5BAE:01FA cmp AX,0x00C0
5BAE:01FD jb short 0x0211
5BAE:01FF mov BX,0x8888
5BAE:0202 cmp AX,0x0180
5BAE:0205 jb short 0x0211
5BAE:0211 mov word ptr CS:[0x013B],BX
5BAE:0216 pop BX
5BAE:0217 mov byte ptr CS:[0x013E],BL
5BAE:021C mov AL,byte ptr CS:[0x0139]
5BAE:0220 or AL,AL
5BAE:0222 jns short 0x022A
5BAE:0224 or AL,0x40
5BAE:0226 mov byte ptr CS:[0x0139],AL
5BAE:022A ret far
5BAE:022B mov byte ptr CS:[0x013F],AL
5BAE:022F mov byte ptr CS:[0x013E],AL
5BAE:0233 mov word ptr CS:[0x013B],0xFFFF
5BAE:023A ret far
5BAE:0250 push DS
5BAE:0251 push CS
5BAE:0252 pop DS
5BAE:0253 mov byte ptr DS:[0x013A],AL
5BAE:0256 mov AX,word ptr ES:[SI]
5BAE:0259 mov DI,0x0246
5BAE:025C mov word ptr DS:[DI],SI
5BAE:025E mov word ptr DS:[DI+2],ES
5BAE:0261 mov word ptr DS:[DI+4],AX
5BAE:0264 mov AX,word ptr ES:[SI+0x4000]
5BAE:0269 mov word ptr DS:[DI+6],AX
5BAE:026C mov AX,word ptr ES:[SI-32768]
5BAE:0271 mov word ptr DS:[DI+8],AX
5BAE:0274 add SI,2
5BAE:0277 mov word ptr DS:[0x0115],SI
5BAE:027B mov word ptr DS:[0x0117],ES
5BAE:027F sub SI,2
5BAE:0282 add SI,word ptr ES:[SI]
5BAE:0285 mov word ptr DS:[0x0119],SI
5BAE:0289 mov word ptr DS:[0x011B],ES
5BAE:028D call near 0x052F
5BAE:0290 call near 0x02AE
5BAE:0293 mov AL,byte ptr DS:[0x013F]
5BAE:0296 mov byte ptr DS:[0x013D],AL
5BAE:0299 mov byte ptr DS:[0x013E],AL
5BAE:029C xor AX,AX
5BAE:029E mov word ptr DS:[0x011D],AX
5BAE:02A1 mov word ptr DS:[0x0123],AX
5BAE:02A4 call near 0x036F
5BAE:02A7 mov AL,0x80
5BAE:02A9 mov byte ptr DS:[0x0139],AL
5BAE:02AC pop DS
5BAE:02AD ret far
5BAE:02AE push DS
5BAE:02AF push DS
5BAE:02B0 pop ES
5BAE:02B1 mov word ptr DS:[0x0140],0
5BAE:02B7 lds SI,word ptr DS:[0x0115]
5BAE:02BB mov BP,SI
5BAE:02BD mov DI,0x0166
5BAE:02C0 mov CX,9
5BAE:02C3 lods AX,word ptr DS:[SI]
5BAE:02C4 or AX,AX
5BAE:02C6 je short 0x02CF
5BAE:02C8 inc word ptr CS:[0x0140]
5BAE:02CD add AX,BP
5BAE:02CF stos word ptr ES:[DI],AX
5BAE:02D0 loop 0x02C3
5BAE:02D2 mov DI,0x019C
5BAE:02D5 mov CL,9
5BAE:02D7 mov AL,0x60
5BAE:02D9 rep stos byte ptr ES:[DI],AL
5BAE:02DB pop DS
5BAE:02DC les SI,word ptr DS:[0x0115]
5BAE:02E0 mov word ptr DS:[0x011F],1
5BAE:02E6 mov word ptr DS:[0x0121],0x0060
5BAE:02EC mov CX,9
5BAE:02EF mov DI,0x0142
5BAE:02F2 mov SI,word ptr DS:[DI+0x24]
5BAE:02F5 mov word ptr DS:[DI+0x12],SI
5BAE:02F8 mov word ptr DS:[DI],0xFFFF
5BAE:02FC or SI,SI
5BAE:02FE je short 0x0309
5BAE:0300 mov AX,CX
5BAE:0302 call near 0x049B
5BAE:0305 inc word ptr DS:[DI]
5BAE:0307 mov CX,AX
5BAE:0309 add DI,2
5BAE:030C loop 0x02F2
5BAE:030E ret near
5BAE:030F push DS
5BAE:0310 mov AX,CS
5BAE:0312 mov DS,AX
5BAE:0314 mov AL,byte ptr DS:[0x0139]
5BAE:0317 or AL,AL
5BAE:0319 jns short 0x033C
5BAE:031B dec byte ptr DS:[0x011E]
5BAE:031F jns short 0x0333
5BAE:0321 call near 0x0349
5BAE:0324 jne short 0x033C
5BAE:0326 push DX
5BAE:0327 push SI
5BAE:0328 push DI
5BAE:0329 push BP
5BAE:032A push ES
5BAE:032B call near 0x036F
5BAE:032E pop ES
5BAE:032F pop BP
5BAE:0330 pop DI
5BAE:0331 pop SI
5BAE:0332 pop DX
5BAE:0333 rol word ptr DS:[0x013B],1
5BAE:0337 jae short 0x033C
5BAE:0339 call near 0x04D7
5BAE:033C mov AL,byte ptr DS:[0x0139]
5BAE:033F mov BX,word ptr DS:[0x011F]
5BAE:0343 mov CX,word ptr DS:[0x0121]
5BAE:0347 pop DS
5BAE:0348 ret far
5BAE:0349 push SI
5BAE:034A push ES
5BAE:034B les SI,word ptr DS:[0x0246]
5BAE:034F mov AX,word ptr ES:[SI]
5BAE:0352 cmp word ptr DS:[0x024A],AX
5BAE:0356 jne short 0x036C
5BAE:0358 mov AX,word ptr ES:[SI+0x4000]
5BAE:035D cmp word ptr DS:[0x024C],AX
5BAE:0361 jne short 0x036C
5BAE:0363 mov AX,word ptr ES:[SI-32768]
5BAE:0368 cmp word ptr DS:[0x024E],AX
5BAE:036C pop ES
5BAE:036D pop SI
5BAE:036E ret near
5BAE:036F les BX,word ptr DS:[0x0115]
5BAE:0373 mov AX,word ptr ES:[BX+0x30]
5BAE:0377 add word ptr DS:[0x011D],AX
5BAE:037B mov DI,0x0142
5BAE:037E call near 0x03C7
5BAE:0381 mov CX,word ptr DS:[0x0140]
5BAE:0385 dec word ptr DS:[DI]
5BAE:0387 jne short 0x03B2
5BAE:0389 mov SI,word ptr DS:[DI+0x12]
5BAE:038C or SI,SI
5BAE:038E je short 0x03B2
5BAE:0390 push CX
5BAE:0391 push DI
5BAE:0392 lods AX,word ptr ES:[SI]
5BAE:0394 mov DX,DI
5BAE:0396 sub DX,0x0142
5BAE:039A shr DX,1
5BAE:039C mov BX,AX
5BAE:039E and BX,0x0070
5BAE:03A1 shr BX,1
5BAE:03A3 shr BX,1
5BAE:03A5 shr BX,1
5BAE:03A7 call near word ptr DS:[BX+0x0129]
5BAE:03AB pop DI
5BAE:03AC pop CX
5BAE:03AD cmp word ptr DS:[DI],0
5BAE:03B0 je short 0x0389
5BAE:03B2 add DI,2
5BAE:03B5 loop 0x0385
5BAE:03B7 dec byte ptr DS:[0x0121]
5BAE:03BB jne short 0x03C6
5BAE:03BD mov byte ptr DS:[0x0121],0x60
5BAE:03C2 inc word ptr DS:[0x011F]
5BAE:03C6 ret near
5BAE:03C7 cmp word ptr DS:[0x0123],0
5BAE:03CC jne short 0x03F8
5BAE:03CE mov AX,word ptr ES:[BX+0x2A]
5BAE:03D2 cmp AX,word ptr DS:[0x011F]
5BAE:03D6 jne short 0x03F7
5BAE:03D8 cmp word ptr DS:[0x0121],0x0060
5BAE:03DD jne short 0x03F7
5BAE:03DF push DI
5BAE:03E0 push ES
5BAE:03E1 mov SI,DI
5BAE:03E3 add DI,0x0036
5BAE:03E6 push DS
5BAE:03E7 pop ES
5BAE:03E8 mov CX,0x0012
5BAE:03EB rep movs word ptr ES:[DI],word ptr DS:[SI]
5BAE:03ED pop ES
5BAE:03EE pop DI
5BAE:03EF mov AX,word ptr ES:[BX+0x2E]
5BAE:03F3 dec AX
5BAE:03F4 mov word ptr DS:[0x0123],AX
5BAE:03F7 ret near
5BAE:041C call near 0x049B
5BAE:041F jmp near 0x0592
5BAE:0422 call near 0x049B
5BAE:0425 jmp near 0x0592
5BAE:0428 mov CL,byte ptr ES:[SI]
5BAE:042B inc SI
5BAE:042C call near 0x049B
5BAE:042F jmp near 0x05A6
5BAE:0432 mov CL,byte ptr ES:[SI]
5BAE:0435 inc SI
5BAE:0436 call near 0x049B
5BAE:0439 cmp AH,7
5BAE:043C jne short 0x0450
5BAE:043E mov BX,AX
5BAE:0440 and BX,0x000F
5BAE:0443 mov byte ptr DS:[BX+0x019C],CL
5BAE:0447 push AX
5BAE:0448 mov AL,byte ptr DS:[0x013D]
5BAE:044B mul CL
5BAE:044D mov CL,AH
5BAE:044F pop AX
5BAE:0450 jmp near 0x05A6
5BAE:049B push AX
5BAE:049C push CX
5BAE:049D xor AX,AX
5BAE:049F lods AL,byte ptr ES:[SI]
5BAE:04A1 or AL,AL
5BAE:04A3 jns short 0x04CF
5BAE:04A5 xor CX,CX
5BAE:04A7 mov CH,CL
5BAE:04A9 mov CL,AH
5BAE:04AB mov AH,AL
5BAE:04AD lods AL,byte ptr ES:[SI]
5BAE:04AF or AL,AL
5BAE:04B1 js short 0x04A7
5BAE:04B3 and AX,0x7F7F
5BAE:04B6 and CX,0x7F7F
5BAE:04BA shl CL,1
5BAE:04BC shr CX,1
5BAE:04BE shl AL,1
5BAE:04C0 shl AX,1
...
5BAE:04C6 shr CX,1
5BAE:04C8 rcr AX,1
5BAE:04CA jcxz short 0x04CF
5BAE:04CF mov word ptr DS:[DI],AX
5BAE:04D1 mov word ptr DS:[DI+0x12],SI
5BAE:04D4 pop CX
5BAE:04D5 pop AX
5BAE:04D6 ret near
5BAE:04D7 mov AL,byte ptr DS:[0x013D]
5BAE:04DA sub AL,byte ptr DS:[0x013E]
5BAE:04DE jne short 0x04EC
5BAE:04E0 mov word ptr DS:[0x013B],1
5BAE:04E6 and byte ptr DS:[0x0139],0xBF
5BAE:04EB ret near
5BAE:04EC push DX
5BAE:04ED push SI
5BAE:04EE push DI
5BAE:04EF push BP
5BAE:04F0 push ES
5BAE:04F1 jb short 0x04FB
5BAE:04F3 cmp AL,3
5BAE:04F5 jb short 0x0501
5BAE:04F7 mov AL,3
5BAE:04F9 jmp short 0x0501
5BAE:0501 sub byte ptr DS:[0x013D],AL
5BAE:0505 mov BL,byte ptr DS:[0x013D]
5BAE:0509 mov SI,0x019C
5BAE:050C mov DX,0x07B0
5BAE:050F lods AL,byte ptr DS:[SI]
5BAE:0510 mul BL
5BAE:0512 mov CL,AH
5BAE:0514 mov AX,DX
5BAE:0516 call near 0x05A6
5BAE:0519 inc DX
5BAE:051A cmp DL,0xBA
5BAE:051D jb short 0x050F
5BAE:052F mov word ptr CS:[0x0127],0x0050
5BAE:0536 xor DX,DX
5BAE:0538 mov AX,0x7BB0
5BAE:053B or AL,DL
5BAE:053D xor CL,CL
5BAE:053F call near 0x05A6
5BAE:0542 mov AX,0x00E0
5BAE:0545 or AL,DL
5BAE:0547 mov CL,0x40
5BAE:0549 call near 0x05A6
5BAE:054C inc DX
5BAE:054D cmp DX,0x000A
5BAE:0550 jb short 0x0538
5BAE:0552 mov word ptr CS:[0x0127],1
5BAE:0559 mov BL,0xFF
5BAE:055B call near 0x0564
5BAE:055E mov BL,0x3F
5BAE:0560 call near 0x0564
5BAE:0563 ret near
5BAE:0592 push BX
5BAE:0593 push CX
5BAE:0594 push DX
...
5BAE:0596 mov BX,AX
5BAE:0598 cli
5BAE:0599 call near 0x05BF
5BAE:059C mov BL,BH
5BAE:059E call near 0x05BF
5BAE:05A1 popf
5BAE:05A2 pop DX
5BAE:05A3 pop CX
5BAE:05A4 pop BX
...
5BAE:05AC push CX
5BAE:05AD cli
5BAE:05AE call near 0x05BF
5BAE:05B1 mov BL,BH
5BAE:05B3 call near 0x05BF
5BAE:05B6 pop BX
5BAE:05B7 call near 0x05BF
5BAE:05BA popf
5BAE:05BB pop DX
5BAE:05BC pop CX
5BAE:05BD pop BX
