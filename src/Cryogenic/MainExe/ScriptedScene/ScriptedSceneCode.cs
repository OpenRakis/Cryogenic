...
public class ScriptedSceneCode : CSharpOverrideHelper {
    ...
    public Action LoadSceneSequenceDataIntoAXAndAdvanceSI_1ED_93F_280F() {
        ...
        uint address = MemoryUtils.ToPhysicalAddress(_state.CS, offset);
